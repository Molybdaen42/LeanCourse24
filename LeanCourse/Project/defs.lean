...
-- A line is a tangent to a parabola iff they have exactly one intersection point
-- and the line is not orthogonal to the directrix of the parabola.
-- Use this on the two parabolas with focal points z₁ resp. z₂ and directrix l₁ resp. l₂.
-- The returned tangent line is the line generated by O6.
