...
def generate_lines (M : Set ℂ) (L : Set line) : Set line := {l : line |
  (∃ z₁ ∈ M, ∃ z₂ ∈ M, z₁ ≠ z₂ ∧ l.eq (O1 z₁ z₂ (by sorry)))
  ∨
  (∃ z₁ ∈ M, ∃ z₂ ∈ M, z₁ ≠ z₂ ∧ l.eq (O2 z₁ z₂ (by sorry)))
  ∨
  (∃ l₁ ∈ L, ∃ l₂ ∈ L, l.eq (O3 l₁ l₂))
  ∨
  (∃ l₁ ∈ L, ∃ l₂ ∈ L, l.eq (O3' l₁ l₂))
  ...
  (∃ z₁ ∈ M, ∃ l₁ ∈ L, l.eq (O4 z₁ l₁))
  ∨
  (∃ z₁ ∈ M, ∃ z₂ ∈ M, z₁ ≠ z₂ ∧ ∃ l₁ ∈ L, ∃ l' ∈ O5 z₁ z₂ (by sorry) l₁, l.eq l')
  ∨
  (∃ z₁ ∈ M, ∃ z₂ ∈ M, z₁ ≠ z₂ ∧ ∃ l₁ ∈ L, ∃ l₂ ∈ L, ∃ l' ∈ O6 z₁ z₂ (by sorry) l₁ l₂, l.eq l')
  --∨
